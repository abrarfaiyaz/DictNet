...
python dictnet_train.py $protocol/List1_train_norm_dwi.txt $protocol/List2_train_brain_mask.txt $protocol/List10_train_T2.txt $protocol/List20_train_FA.txt $protocol/List3_train_ficvf.txt $protocol/List4_train_fiso.txt $protocol/List5_train_odi.txt  $OUTPUTDIR $proto $seed

python dictnet_test.py $protocol/List1_train_norm_dwi.txt $protocol/List6_test_norm_dwi.txt $protocol/List7_test_brain_mask.txt $protocol/List11_test_T2.txt $protocol/List21_test_FA.txt $OUTPUTDIR $proto $seed
